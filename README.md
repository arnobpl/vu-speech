# VuSpeech app using Google Cloud Speech API 10/01/2020

This directory contains Android example that uses the
[Google Cloud Speech API](https://cloud.google.com/speech/) to communicate with ReSpeaker Core V2.0 running ODAS library via wi-fi link.
